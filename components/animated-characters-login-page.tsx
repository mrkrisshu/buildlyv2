...
function LoginPage({ isSignup = false }: { isSignup?: boolean }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : (isSignup ? "Signup failed. Please try again." : "Login failed. Please try again."));
    }
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2">
              {isSignup ? "Create Your Account" : "Welcome to Buildly!"}
            </h1>
            <p className="text-muted-foreground text-sm">
              {isSignup ? "Sign up to start building with AI" : "Sign in to start building with AI"}
            </p>
          </div>
